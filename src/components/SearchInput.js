        ...
        <form id="search_form" className="position-relative" onSubmit={handleSubmit}>
            <div className="input-group input-group-sm w-100">
                ...
                <div className="input-group-append">
                    <button className="btn btn-outline-success" type="submit" id="search_button">Find</button>
                </div>
            </div>

            <div id="alpha_numeric_alert" className="input-alert alert alert-danger" style={{display: 'none'}}>Wrong character, please type only letters and numbers!</div>
            <div id="empty_input_alert" className="input-alert alert alert-danger" style={{display: 'none'}}>Search field is empty, please type something to search!</div>
        </form>
    );
}
